...
这一章集中演示 v3.1 日志外观、输出格式、运行时控制和文件滚动。建议在完成
...
| [`03-runtime-control`](./03-runtime-control/README.md) | 运行时调整级别、暂停/恢复输出并读取状态 |
| [`04-file-rotation`](./04-file-rotation/README.md) | 配置文件名、大小/日期滚动、清理和压缩 |

每个子目录都有完整源码、配置、`run.bat` 和 `run.sh`。完整规则见
[v3.1 日志教程](../../docs/maintenance/v3.1/guides/logging.md)。
