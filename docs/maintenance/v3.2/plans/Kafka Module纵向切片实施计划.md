...
- [ ] **Step 2: 先写默认值、非法组合、TLS/SASL、Hook 不变量失败测试**
...
- [ ] **Step 3: 实现明确所有权和 Sonic/PB Codec**
...
- [ ] **Step 1: 写 Service 队列预留、取消和串行协程失败测试**
...
- [ ] **Step 3: 复用 Service completion 原语实现**
...
- [ ] **Step 1: 写成功 Mark、失败不 Mark、同 Partition 顺序和批次边界失败测试**
...
- [ ] **Step 3: 实现 Claim 到 Service 的一次派发**
...
- [ ] **Step 2: 固定官方稳定 Kafka 镜像并提交 Compose**
...
- [ ] **Step 6: Windows 连接 Ubuntu Smoke**
